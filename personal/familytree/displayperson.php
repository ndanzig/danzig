...
echo "<LINK REL=STYLESHEET HREF='forms.css' TYPE='text/css'>";
  ...
  echo "<title>Display Family Member</title>";
  echo "</head>";
  echo "<body >"; 
...
if (""!=$fields[3])
{print " <h4> <i> $hebrewname </i></h4>";}

if (""!=$fields[4])
{print "  Birth date: $birth,";} 
if (""!=($fields[5]))
{print " Death date: $death"; }
if (""!=($fields[6]))
{print " <br> Birth place: $birthplace, ";} 
if (""!=($fields[7]))
{print "Place of death: $deathplace";}
...
$result2 = mysql_query($query2) or die('Query failed: ' . mysql_error());
   ...
   if ($num_rows!=0)
   {
	...
	echo " <input type='hidden' name='person' value=$displayname > $relationship of ";
	echo " <input type=submit value=$displayname>";
	echo "</form>";
   }//endif row_num!=0
  }//end WHILE
...
while ($line = mysql_fetch_array($result, MYSQL_ASSOC)) 
   ...
   $lastname = $fields[2];
   echo '<form action="displayperson.php" method="POST" >';
   echo " <input type='hidden' name='person' value=$firstname >  ";
   echo " <input type=submit value=$firstname>";
   echo "</form>";
   }
}
